// DeusTest.cpp: определ€ет точку входа дл€ консольного приложени€.
//
#include "stdafx.h"
#include <stdio.h>
#include <stdlib.h>
...
int main()
{
	//подготовим входные данные.
	 ...
	 //координаты наших 3 точек в локальной системе координат ќ
	 ...
	 //преобразуем входные данные дл€ использовани€ в методе CalculateAP3P
	 std::vector<vector<double>> vec_points3d = ToVec(list_points3d);
	 std::vector<vector<double>> vec_points2d = ToVec(list_points2d);

	 //здесь будет хранитс€ результат CalculateAP3P. “о есть матрица поворота R и вектор трансл€ции(сдвига) “
...
// настройка параметров камеры. мо€ реализаци€ не учитывает ее. 
